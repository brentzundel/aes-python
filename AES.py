...
GFMult performs finite field multiplication for Galois
...
def GetColumns(state, Nb=4):
    """
GetColumns(state, n_b=4) -> column list
...
def InvCipher(IN, keys, Nk, Nb=4):
    """
InvCipher(IN, key, Nk, n_b = 4) -> state
